package com.epam.spacex.presentation.base
...
import com.epam.spacex.presentation.base.event.common.LiveEventMap
...
abstract class BaseViewModel : ViewModel(), LifecycleObserver {
    ...
    protected open fun onException(error: RepositoryException) {
        ...
        val unknownErrorMsg =
            SpaceXApp.instance.getString(com.epam.spacex.R.string.global_unknown_error)
